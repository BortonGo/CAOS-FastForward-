...
И используем **clang-format** для проверки форматирования. Убедитесь что они установлены в вашей системе.
...
`apt update && apt install -y gcc g++ clang-format`
...
`brew install gcc g++ clang-format`
