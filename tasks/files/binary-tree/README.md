...
Например, для этого [файла](tests/001.dat) надо вывести `9 8 7 6 5 4 3 2 1`
...
Для небольших буферов фиксированного размера использовать динамическую память неэффективно


Не используйте низкоуровневые манипуляции с памятью
