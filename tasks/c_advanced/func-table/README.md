...
Не используйте %s - возможно переполнение буфера


Лучше объявлять не {{a,b,c,NULL}, {A,B,C}}, а {{a,A}, {b,B}, {c,C}, {NULL,NULL}}, чтобы гарантировать точное соответствие имен и функций
